...
export default function StepUpSIPWithLump({ currency = 'INR' }) {
  ...
  }, [annualRate, initialSIP, lumpSum, stepUpPercent, totalYears, isLimitedPay, sipYears, startDate]);
      ...
      table={
        <div className="mt-8">
          ...
          <InvestmentGoalTracker
            ...
            years={totalYears}
            strategy="stepUpSipPlusLump"
            currentInitialSIP={initialSIP}
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              <button
                onClick={() => {
                  ...
                  downloadCSV(data, ['Year', 'Invested', 'Interest', 'Balance'], 'step_up_lumpsum_schedule.csv');
                }}
