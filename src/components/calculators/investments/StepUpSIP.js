...
export default function StepUpSIP({ currency, setCurrency }) {
  ...
  }, [annualRate, initialSIP, stepUpPercent, totalYears, isLimitedPay, sipYears, startDate]);
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              <button
                onClick={() => {
                  ...
                  downloadCSV(data, ['Year', 'Invested', 'Interest', 'Balance'], 'step_up_sip_schedule.csv');
                }}
