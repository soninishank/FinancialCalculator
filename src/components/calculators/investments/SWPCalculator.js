          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-amber-700 dark:text-amber-400 mt-1 leading-relaxed">
                Your withdrawal inflation rate ({inflationRate}%) is equal to or higher than your expected returns ({annualRate}%).
                This means your <strong>corpus will deplete faster</strong> as withdrawals increase faster than investment growth.
              </p>
            </div>
          </div>
        </div>
